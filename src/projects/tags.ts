...
export default {
  ...
  nextjs: { title: 'Next.js', href: 'https://nextjs.org/' },
  threejs: { title: 'Three.js', href: 'https://threejs.org/' },
  typescript: { title: 'Typescript', href: 'https://www.typescriptlang.org/' },
  tailwind: { title: 'Tailwind CSS', href: 'https://tailwindcss.com/' },
  docker: { title: 'Docker', href: 'https://www.docker.com/' },
